...
| `rearranca_pcv_usuario.php` | Script php que permite al personal de helpdesk reiniciar un PCV que se ha colgado| 4.5.5 |
...
| `vm_cold_restart_vm.ps1` | Script powercli que reinicia por las malas un PCV | 4.5.5 |
...
| `vm_restart_vm.ps1` | Script que reinicia por las buenas un PCV | 4.5.5 |
